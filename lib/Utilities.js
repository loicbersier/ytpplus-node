...
class {
    ...
    snipVideo(video, startTime, endTime, output,resolution){
        var command = this.FFMPEG
            ...
            + " -ac 1"
            + " -ar 44100"
            + " -vf scale="+resolution[0]+"x"+resolution[1]+",setsar=1:1,fps=fps=30,drawtext=fontfile='./asset/impact.ttf':text='"+video+"':fontcolor=white:box=1:boxcolor=black:boxborderw=5"
            + " -y"
            + " " + output + ".mp4";
